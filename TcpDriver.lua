...
event.listen("tcp_send",TcpEvent)
event.listen("tcp_recieve",TcpEvent)
event.listen("tcp_close",TcpEvent)
event.listen("tcp_abort",TcpEvent)
event.listen("tcp_timewait_timeout",TcpEvent)